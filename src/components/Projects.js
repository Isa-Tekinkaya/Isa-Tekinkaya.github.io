...
export default function Projects() {
  ...
  <div className={`projectCard fade-in-section ${isVisibleSea ? 'is-visible' : ''}`} ref={seaRef}>
    <ul className="projects">
      ...
      <div className="card-footer">
        <a className="view-code-button" href="https://isa-tekinkaya.github.io/Capstone-Project/"><button className="view-code-button-link">View Project</button></a>
        <a className="view-code-button" href="https://github.com/Isa-Tekinkaya/Capstone-Project"><button className="view-code-button-link">View Code</button></a>
      </div>
    </ul>
  ...
  <div className={`projectCard fade-in-section ${isVisibleMountain ? 'is-visible' : ''}`} ref={mountainRef}>
    <ul className="projects">
      ...
      <div className="card-footer">
        <a className="view-code-button" href="https://isa-tekinkaya.github.io/Mountain-Of-Your-Choise.github.io/"><button className="view-code-button-link"> View Project </button></a>
        <a className="view-code-button" href="https://github.com/Isa-Tekinkaya/Mountain-Of-Your-Choise">  <button className="view-code-button-link" > View Code </button> </a>
      </div>
    </ul>
  ...
  <div className={`projectCard fade-in-section ${isVisiblecolorgame ? 'is-visible' : ''}`} ref={colorgameRef}>
    <ul className="projects">
      ...
      <div className="card-footer">
        <a className="view-code-button" href="https://isa-tekinkaya.github.io/CSS-Color-Game/"> <button className="view-code-button-link">View Project</button></a>
        <a className="view-code-button"href="https://github.com/Isa-Tekinkaya/CSS-Color-Game"> <button className="view-code-button-link">View Code </button> </a>
      </div>
    </ul>
  ...
  <div className={`projectCard fade-in-section ${isVisiblePingpong ? 'is-visible' : ''}`} ref={pingpongRef}>
    <ul className="projects">
      ...
      <div className="card-footer">
      <a className="view-code-button" href="https://isa-tekinkaya.github.io/ScoreKeeper/"> <button className="view-code-button-link">View Project</button></a>
        <a className="view-code-button" href="https://github.com/Isa-Tekinkaya/ScoreKeeper"><button className="view-code-button-link">View Code</button></a>
      </div>
    </ul>
